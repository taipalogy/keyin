...
function LurzmafjizPage() {
  ...
  var lexemeRegrAssim = tia.analyze(input, new TonalZeroCombining(), new RegressiveAssimilation());
  var surfaceForm = Object(_src_process__WEBPACK_IMPORTED_MODULE_2__["getSurfaceForms"])(lexemeRegrAssim.word.literal, lexemeRegrAssim.otherForms[0].literal); // const lexemeAgrAssim = tia.analyze(input, new TonalZeroCombining(), new AgressiveAssimila());
  ...
  return __jsx("div", {
    ...
    __self: this
  }), "surface form", surfaceForm.map(function (x) {
    return __jsx("li", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 71
...
//# sourceMappingURL=lurzmafjiz.js.1a22fe14335470a0e00c.hot-update.js.map