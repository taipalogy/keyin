...
var namesInHanji = new Map().set("initial", "初聲").set("medial", "中聲").set("nasalization", "鼻音化").set("stop final", "終聲").set("nasal final", "終聲").set("freeTonal", "聲調").set("checkedTonal", "聲調");
...
function HintPage() {
  ...
  }), hints[idx].namesOfSound[len] + ', ' + hints[idx].hint);
}
...
//# sourceMappingURL=hint.js.d1507345b5951fcf2c03.hot-update.js.map