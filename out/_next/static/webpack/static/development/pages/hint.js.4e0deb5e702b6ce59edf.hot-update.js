...
function HintPage() {
  ...
  }, str, ", ", literals, "\u62CD\u7F85\u99AC\u5B57, \u8F38\u51FA hint", __jsx("label", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 132,
  ...
  }), highlights[0].toString(), __jsx("br", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 143,
  ...
  }), hints.map(function (it) {
    return it.namesOfSound;
  }).join(''));
}
...
//# sourceMappingURL=hint.js.4e0deb5e702b6ce59edf.hot-update.js.map