...
function setHintAndHighlight(index, n) {
  if (hints[index].namesOfSound[n] === taipa__WEBPACK_IMPORTED_MODULE_3__["TonalSoundTags"].freeTonal || hints[index].namesOfSound[n] === taipa__WEBPACK_IMPORTED_MODULE_3__["TonalSoundTags"].checkedTonal) {
    if (tonalInHanji.has(hints[index].sounds[n])) {
      var _tonal = "";
      _tonal = tonalInHanji.get(hints[index].sounds[n]);
      hints[index].hint = namesInHanji.get(hints[index].namesOfSound[n]) + _tonal + ' ' + hints[index].namesOfSound[n];
    }
  } else {
...
function HintPage() {
  ...
  }), hints[idx].namesOfSound[len] + ', ' + hints[idx].hint, __jsx("br", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 140,
...
//# sourceMappingURL=hint.js.1bf7d0804c967d93971e.hot-update.js.map