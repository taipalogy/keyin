...
function TonePatternWordsPage() {
  ...
  var phrases = ['diurhhw qaux', 'tehh cut kih', 'qongy aw'];
  return __jsx("div", {
    __self: this,
    __source: {
  ...
  }, "tokens.length:", tokens.length, ",", tokens[0], ". items.length:", items.length, __jsx("label", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53,
...
//# sourceMappingURL=tonepatternwords.js.d7d31b73b22053280b07.hot-update.js.map